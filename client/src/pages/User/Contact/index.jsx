        ...
        <Container>
          ...
          <article className="contact-wrap">
                ...
                <div className="social">
                  <a href="https://www.facebook.com" rel="noreferrer" target="_blank">
                    <svg height="50" viewBox="0 0 48 48" width="50" x="0px" xmlns="http://www.w3.org/2000/svg" y="0px">
                      <path d="M24 4A20 20 0 1 0 24 44A20 20 0 1 0 24 4Z" fill="#3f51b5"></path>
                      <path
            ...
            <article className="contact-form">
              ...
              <Form name="control-hooks" ref={formRef} onFinish={onFinish}>
                <Form.Item
                  name="name"
                  rules={[
                    {
                ...
                >
                  <Input.TextArea placeholder="Bạn muốn nói gì với chúng tôi?" rows={3} />
                </Form.Item>
                <Form.Item>
